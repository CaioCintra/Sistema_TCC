...
export default function ModalAgendarBanca(props: any) {
  ...
  const confirmarBanca = async () => {
    ...
    await fetch("http://localhost:3333/historico", {
      ...
      body: JSON.stringify({
        ...
        Etapa: "TCC2",
        orientador: props.orientador,
        status_processo: "Banca_TCC2_Confirmada",
      }),
      headers: { "Content-Type": "application/json" },
    });
    ...
    try {
      ...
      await fetch("http://localhost:3333/historico", {
        ...
        body: JSON.stringify({
          ...
          Etapa: "TCC2",
          orientador: props.orientador,
          status_processo: "Banca_TCC2_Agendada",
        }),
        headers: { "Content-Type": "application/json" },
      });
        ...
        <Fade in={open}>
          <Box sx={style}>
            ...
            <form onSubmit={cadastrarBanca} id="form">
              ...
              {props.status === "Banca_TCC2_Agendada" ? (
                <>
                  <Button
                    variant="contained"
                    color="success"
